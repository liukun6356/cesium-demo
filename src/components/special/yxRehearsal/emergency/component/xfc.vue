...
<script>
// import xfc from "../../data/xfc.gltf"   // 类型不支持
...
export default {
  data() {
    return {
      ...
      pathConfig: { // 路径
        ...
        position: [
          [102.52326, 24.409876, 1667],
          [102.5225, 24.40789, 1660],
          [102.522465, 24.407582, 1656],
          [102.523768, 24.406763, 1650],
          [102.523982, 24.4071, 1653],
          [102.524448, 24.407286, 1653],
          [102.524826, 24.408136, 1653],
        ],
      },
  ...
  methods: {
    async start() {
      ...
      xfcDatasource = await window.dasViewer.dataSources.add(Cesium.CzmlDataSource.load(czml, {clampToGround: true}))
    },
