...
haoutil.version = "2.3",
    ...
    haoutil.oneMsg = function (t, e) {
        haoutil.storage.get(e) || (haoutil.msg(t),
            haoutil.storage.add(e, !0))
    }
    ,
    ...
    haoutil.loading = {
        ...
        show: function (t) {
            this.close(),
                window.NProgress ? ((t = t || {}).color ? t.template = '<div class="bar ' + (t.className || "") + '" style="background-color:' + t.color + ';" role="bar"></div><div class="spinner" role="spinner"><div class="spinner-icon"></div></div>' : t.template = '<div class="bar ' + (t.className || "") + '" role="bar"></div><div class="spinner" role="spinner"><div class="spinner-icon"></div></div>',
                    NProgress.configure(t),
                    NProgress.start()) : window.layer && (this.index = layer.load(2, {
                        shade: [.3, "#000000"]
                    }))
        },
        hide: function () {
        ...
        close: function () {
            window.NProgress ? NProgress.done(!0) : window.layer && (-1 != this.index && layer.close(this.index),
                this.index = -1)
        }
    },
    ...
    Date.prototype.format = function (t) {
        ...
        for (var n in /(y+)/.test(t) && (t = t.replace(RegExp.$1, (this.getFullYear() + "").substr(4 - RegExp.$1.length))),
            /(E+)/.test(t) && (t = t.replace(RegExp.$1, (1 < RegExp.$1.length ? 2 < RegExp.$1.length ? "星期" : "周" : "") + {
                0: "日",
                1: "一",
                2: "二",
                3: "三",
        ...
        return {
            ...
            get: function (t) {
                ...
                if (i && null != window.plus) {
                    if (null == (e = plus.navigator.getCookie(t)))
                        return null
                } else
                    e = document.cookie;
    ...
    haoutil.file = function () {
        ...
        function r(t) {
            for (var e = t.split(";base64,"), n = e[0].split(":")[1], r = window.atob(e[1]), o = r.length, i = new Uint8Array(o), a = 0; a < o; ++a)
                i[a] = r.charCodeAt(a);
            return new Blob([i], {
                type: n
            })
    ...
    haoutil.str = function () {
        ...
        return {
            ...
            formatTime: function (t) {
                return Number(t),
                    t < 60 ? t.toFixed(0) + "秒" : 60 <= t && t < 3600 ? Math.floor(t / 60) + "分钟" + Math.floor(t % 60) + "秒" : (t = Math.floor(t / 60),
                        Math.floor(t / 60) + "小时" + Math.floor(t % 60) + "分钟")
            },
            base64: function (t) {
                return function (t) {
            ...
            decodeBase64: function (t) {
                return function (t) {
                    for (var e = "", n = 0; n < t.length; n += 8)
                        e += String.fromCharCode(parseInt(t.substr(n, 8), 2));
                    return e
                }(function (t) {
        ...
        return {
            getRequest: function () {
                ...
                if (-1 != t.indexOf("?"))
                    for (var n = t.substr(1).split("&"), r = 0; r < n.length; r++)
                        e[n[r].split("=")[0]] = decodeURI(n[r].split("=")[1]);
                return e
            },
            ...
            clone: function t(e) {
                ...
                if (e instanceof Date)
                    return (n = new Date).setTime(e.getTime()),
                        n;
                ...
                n = {};
                for (var i in e)
                    "_layer" != i && "_layers" != i && "_parent" != i && e.hasOwnProperty(i) && (n[i] = t(e[i]));
                return n
            },
