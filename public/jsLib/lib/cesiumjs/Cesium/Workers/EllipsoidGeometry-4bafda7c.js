...
define(['exports', './when-ca071c93', './Check-802a3f11', './Math-439e03ae', './Cartesian2-be0369bc', './Transforms-01f84fc8', './ComponentDatatype-2a7010d1', './GeometryAttribute-76dbac20', './GeometryAttributes-3b5bdbdf', './IndexDatatype-f1ac8920', './GeometryOffsetAttribute-20609f84', './VertexFormat-07d7ff51'], function (exports, when, Check, _Math, Cartesian2, Transforms, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, VertexFormat) { 'use strict';
  ...
  EllipsoidGeometry.packedLength =
    2 * Cartesian2.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength + 7;
  ...
  EllipsoidGeometry.createGeometry = function (ellipsoidGeometry) {
    ...
    slicePartitions = Math.round(
      (slicePartitions * Math.abs(maximumClock - minimumClock)) /
        _Math.CesiumMath.TWO_PI
    );
    stackPartitions = Math.round(
      (stackPartitions * Math.abs(maximumCone - minimumCone)) / _Math.CesiumMath.PI
    );
    ...
    if (
      ...
      for (i = 0; i < vertexCount; i++) {
        ...
        if (vertexFormat.st) {
          ...
          st[stIndex++] =
            Math.atan2(normalST.y, normalST.x) / _Math.CesiumMath.TWO_PI + 0.5;
...
//# sourceMappingURL=EllipsoidGeometry-4bafda7c.js.map
