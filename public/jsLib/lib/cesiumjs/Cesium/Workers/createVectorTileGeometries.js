...
define(['./when-ca071c93', './Check-802a3f11', './Math-439e03ae', './Cartesian2-be0369bc', './Transforms-01f84fc8', './RuntimeError-d605d773', './WebGLConstants-95ceb4e9', './ComponentDatatype-2a7010d1', './GeometryAttribute-76dbac20', './GeometryAttributes-3b5bdbdf', './IndexDatatype-f1ac8920', './createTaskProcessorWorker', './GeometryOffsetAttribute-20609f84', './VertexFormat-07d7ff51', './BoxGeometry-782b6163', './CylinderGeometryLibrary-5bdcd4df', './CylinderGeometry-756a0f34', './EllipsoidGeometry-4bafda7c', './Color-1bffc794'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, createTaskProcessorWorker, GeometryOffsetAttribute, VertexFormat, BoxGeometry, CylinderGeometryLibrary, CylinderGeometry, EllipsoidGeometry, Color) { 'use strict';
