...
define(['exports', './when-ca071c93', './Check-802a3f11', './Transforms-01f84fc8'], function (exports, when, Check, Transforms) { 'use strict';
  ...
  function GeometryInstance(options) {
     ...
     */
    this.modelMatrix = Transforms.Matrix4.clone(
      when.defaultValue(options.modelMatrix, Transforms.Matrix4.IDENTITY)
    );
...
//# sourceMappingURL=GeometryInstance-6159d9d1.js.map
