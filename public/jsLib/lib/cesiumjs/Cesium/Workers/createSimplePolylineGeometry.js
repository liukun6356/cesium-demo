...
define(['./when-ca071c93', './Check-802a3f11', './Math-439e03ae', './Cartesian2-be0369bc', './Transforms-01f84fc8', './RuntimeError-d605d773', './WebGLConstants-95ceb4e9', './ComponentDatatype-2a7010d1', './GeometryAttribute-76dbac20', './GeometryAttributes-3b5bdbdf', './IndexDatatype-f1ac8920', './IntersectionTests-5bf376cb', './Plane-0ff2e313', './ArcType-2b58731c', './EllipsoidRhumbLine-8f5c2e68', './EllipsoidGeodesic-307dec59', './PolylinePipeline-a8d04e88', './Color-1bffc794'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, IntersectionTests, Plane, ArcType, EllipsoidRhumbLine, EllipsoidGeodesic, PolylinePipeline, Color) { 'use strict';
