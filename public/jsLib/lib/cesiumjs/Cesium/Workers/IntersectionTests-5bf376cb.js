...
define(['exports', './when-ca071c93', './Check-802a3f11', './Math-439e03ae', './Cartesian2-be0369bc', './Transforms-01f84fc8'], function (exports, when, Check, _Math, Cartesian2, Transforms) { 'use strict';
  ...
  function quadraticVectorExpression(A, b, c, x, w) {
    ...
    var r0 =
      w *
      (x *
        addWithCancellationCheck$1(A[Transforms.Matrix3.COLUMN2ROW0], A[Transforms.Matrix3.COLUMN0ROW2]) +
        b.z);
    ...
    for (var i = 0; i < length; ++i) {
      ...
      if (_Math.CesiumMath.sign(l2) === _Math.CesiumMath.sign(l0)) {
        left = addWithCancellationCheck$1(
          l2 * cosineSquared + l0,
          l1 * cosine,
...
//# sourceMappingURL=IntersectionTests-5bf376cb.js.map
