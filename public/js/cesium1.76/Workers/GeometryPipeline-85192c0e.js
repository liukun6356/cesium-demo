...
define(['exports', './when-ca071c93', './Check-802a3f11', './Math-439e03ae', './Cartesian2-be0369bc', './Transforms-01f84fc8', './ComponentDatatype-2a7010d1', './GeometryAttribute-76dbac20', './AttributeCompression-38a99216', './EncodedCartesian3-16367c2c', './IndexDatatype-f1ac8920', './IntersectionTests-5bf376cb', './Plane-0ff2e313'], function (exports, when, Check, _Math, Cartesian2, Transforms, ComponentDatatype, GeometryAttribute, AttributeCompression, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane) { 'use strict';
  ...
  function transformVector(matrix, attribute) {
    if (when.defined(attribute)) {
      ...
      for (var i = 0; i < length; i += 3) {
        ...
        scratchCartesian3$1 = Cartesian2.Cartesian3.normalize(
          scratchCartesian3$1,
          scratchCartesian3$1
        );
        Cartesian2.Cartesian3.pack(scratchCartesian3$1, values, i);
  ...
  GeometryPipeline.compressVertices = function (geometry) {
    ...
    for (i = 0; i < numVertices; ++i) {
      if (hasSt) {
        ...
        compressedAttributes[
          normalIndex++
        ] = AttributeCompression.AttributeCompression.compressTextureCoordinates(scratchCartesian2$1);
      }
...
//# sourceMappingURL=GeometryPipeline-85192c0e.js.map
