...
define(['exports', './when-ca071c93', './Check-802a3f11', './Cartesian2-be0369bc', './Transforms-01f84fc8', './ComponentDatatype-2a7010d1', './GeometryAttribute-76dbac20', './GeometryAttributes-3b5bdbdf', './GeometryPipeline-85192c0e', './IndexDatatype-f1ac8920', './WebMercatorProjection-3325b928'], function (exports, when, Check, Cartesian2, Transforms, ComponentDatatype, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, WebMercatorProjection) { 'use strict';
  ...
  function transformToWorldCoordinates(
    ...
    if (toWorld) {
      ...
      Transforms.Matrix4.multiplyTransformation(
        primitiveModelMatrix,
  ...
  function geometryPipeline(parameters) {
    ...
    for (i = 1; i < length; ++i) {
      if (
        when.defined(instances[i].geometry) &&
  ...
  PrimitivePipeline.combineGeometry = function (parameters) {
    ...
    if (length > 0) {
      ...
      if (
        when.defined(instances[0].attributes) &&
        when.defined(instances[0].attributes.offset)
      ) {
    ...
    for (var i = 0; i < length; ++i) {
      ...
      if (when.defined(eastHemisphereGeometry) && when.defined(westHemisphereGeometry)) {
        if (
          when.defined(eastHemisphereGeometry.boundingSphere) &&
          when.defined(westHemisphereGeometry.boundingSphere)
        ) {
        ...
        if (
          when.defined(eastHemisphereGeometry.boundingSphereCV) &&
          when.defined(westHemisphereGeometry.boundingSphereCV)
        ) {
...
//# sourceMappingURL=PrimitivePipeline-e231efd7.js.map
