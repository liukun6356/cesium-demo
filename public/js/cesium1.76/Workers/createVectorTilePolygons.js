...
define(['./when-ca071c93', './Check-802a3f11', './Math-439e03ae', './Cartesian2-be0369bc', './Transforms-01f84fc8', './RuntimeError-d605d773', './WebGLConstants-95ceb4e9', './AttributeCompression-38a99216', './IndexDatatype-f1ac8920', './IntersectionTests-5bf376cb', './Plane-0ff2e313', './createTaskProcessorWorker', './EllipsoidTangentPlane-58601b4f', './OrientedBoundingBox-2fd671b3', './Color-1bffc794'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, Color) { 'use strict';
