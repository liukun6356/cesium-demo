...
define(['./when-ca071c93', './Check-802a3f11', './Math-439e03ae', './Cartesian2-be0369bc', './Transforms-01f84fc8', './RuntimeError-d605d773', './WebGLConstants-95ceb4e9', './ComponentDatatype-2a7010d1', './GeometryAttribute-76dbac20', './GeometryAttributes-3b5bdbdf', './IndexDatatype-f1ac8920', './GeometryOffsetAttribute-20609f84', './EllipsoidRhumbLine-8f5c2e68', './PolygonPipeline-7cba8e8d', './RectangleGeometryLibrary-db850fd6'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, IndexDatatype, GeometryOffsetAttribute, EllipsoidRhumbLine, PolygonPipeline, RectangleGeometryLibrary) { 'use strict';
