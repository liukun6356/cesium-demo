...
define(['./when-ca071c93', './Check-802a3f11', './Math-439e03ae', './Cartesian2-be0369bc', './Transforms-01f84fc8', './RuntimeError-d605d773', './WebGLConstants-95ceb4e9', './ComponentDatatype-2a7010d1', './AttributeCompression-38a99216', './IntersectionTests-5bf376cb', './Plane-0ff2e313', './WebMercatorProjection-3325b928', './createTaskProcessorWorker', './EllipsoidTangentPlane-58601b4f', './OrientedBoundingBox-2fd671b3', './TerrainEncoding-ff66a5ac'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, AttributeCompression, IntersectionTests, Plane, WebMercatorProjection, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, TerrainEncoding) { 'use strict';
